# Note: Compared to the original implementation, the following changes have been made:
#       - all conv2d_weightnorm layers have been replaced by Conv2D and BatchNormalization layers 
from tensorflow.keras.layers import Add, Conv2D, Input, Lambda, BatchNormalization
